...
HISTORICAL_MODEL_MATCH_STAGE_RUN = HOLOLENS3D_RECON_STAGE_ROOT / "run_historical_model_match_from_json.py"
DINO_IDENTITY_STAGE_RUN = HOLOLENS3D_RECON_STAGE_ROOT / "run_dinov2_identity_from_json.py"
...
HISTORICAL_MODEL_MATCH_STAGE_PY = SERVER_PY
DINO_IDENTITY_STAGE_PY = os.environ.get("DINO_IDENTITY_PY", SAM3D_OBJECTS_PY)

...
SHIGURE_TRACKING_BOX_STABILITY_SECONDS = float(
    os.environ.get("SHIGURE_TRACKING_BOX_STABILITY_SECONDS", "1.0")
)
...
if (
    ...
    or not 0.1 <= SHIGURE_TRACKING_BOX_STABILITY_SECONDS <= 10.0

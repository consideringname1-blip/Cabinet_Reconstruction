...
- Repository symlink:
  `/workspace/code/reconstruction/sam3d-body/checkpoints/sam-3d-body-dinov3`
...
```bash
/opt/miniconda/envs/sam_3d_body/bin/hf download facebook/sam-3d-body-dinov3
/opt/miniconda/envs/sam_3d_body/bin/python -c "import torch; torch.hub.load('facebookresearch/dinov3:main', 'dinov3_vith16plus', source='github', pretrained=False, drop_path=0.0)"
```
